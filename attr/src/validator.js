...
(function() {
  ...
  define('mcore-attr/validator', ['jquery', 'mcore/template', 'formSerializer'], function($, Template) {
    "use strict";
    var ValidatorAttr, _isAlphabetReg, _isDateReg, _isEmailReg, _isIDReg, _isMobileReg, _isTelReg, errMsg, exports, rule, urlCheck;
