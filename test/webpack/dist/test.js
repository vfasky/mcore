...
/***/ function(module, exports, __webpack_require__) {
	...
	Template.formatters = __webpack_require__(12);

	Template.components = {};

	Template.binders = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	listDiff = __webpack_require__(10);

	ref = __webpack_require__(7), isString = ref.isString, each = ref.each;
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(7), setElementAttr = ref.setElementAttr, removeElementAttr = ref.removeElementAttr, toArray = ref.toArray, each = ref.each;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(11).diff
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(scope, __mc__observe){
	    ...
	    (function(scope, tree){ // startTree 0
	        ...
	        var __mc__new_el = new __mc_T_El('span', __mc__attr, __mc__children_0);        var __mc__attr__keys = objectKeys(__mc__attr);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(scope, __mc__observe){
	                ...
	                for(var k=0, len=__mc__arr.length; k < len; k++){
	                    ...
	                    if( scope.time ){
	                        ...
	                        (function(scope, tree){ // startTree 7
	                            ...
	                            tree.push( "             " + __mc__rp__key_0 + "              " );
	                            var __mc__children_8 = [], __mc__attr = {}, __mc__isBindObserve = false, __mc__binderData = [];
	 ...
	 if( __mc_T_binders.hasOwnProperty('href') ){
	    __mc__isBindObserve = true;
	    __mc__binderData.push({attrName: 'href', value: __mc__attr['href']});
	 }// end 
