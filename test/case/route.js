...
(function() {
  define('case/route', ['describe', 'it', 'mcore', 'assert'], function(describe, it, mcore, assert) {
    "use strict";
    var route;
    route = mcore.route;
    ...
    describe('route test History Api', function() {
      return it('changeByHistory', function() {
        window.location.hash = '#/index/12/13';
        return route.Route.changeByHistory(function(data) {
          return assert.equal(data, '/index/12/13');
        });
      });
    });
